...
var file_shar_workflow_models_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x05, 0x52, 0x05, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x2a, 0x2d, 0x0a, 0x0d, 0x54,
	...
	0x74, 0x65, 0x10, 0x04, 0x2a, 0x5e, 0x0a, 0x09, 0x4c, 0x6f, 0x67, 0x53, 0x6f, 0x75, 0x72, 0x63,
	...
	0x6f, 0x62, 0x10, 0x04, 0x2a, 0x2c, 0x0a, 0x0d, 0x52, 0x65, 0x74, 0x72, 0x79, 0x53, 0x74, 0x72,
	...
	0x6f, 0x72, 0x6b, 0x66, 0x6c, 0x6f, 0x77, 0x10, 0x03, 0x32, 0xe3, 0x0e, 0x0a, 0x04, 0x53, 0x68,
...
var file_shar_workflow_models_proto_msgTypes = make([]protoimpl.MessageInfo, 134)
var file_shar_workflow_models_proto_goTypes = []interface{}{
	...
	nil,                                      // 127: Workflow.ProcessEntry
	nil,                                      // 128: Workflow.MessageReceiversEntry
	nil,                                      // 129: Element.InputTransformEntry
	nil,                                      // 130: Element.OutputTransformEntry
	nil,                                      // 131: Timer.OutputTransformEntry
	nil,                                      // 132: CatchError.OutputTransformEntry
	nil,                                      // 133: WorkflowState.SatisfiesGatewayExpectationEntry
	nil,                                      // 134: WorkflowState.GatewayExpectationsEntry
	nil,                                      // 135: Gateway.MetExpectationsEntry
	nil,                                      // 136: ProcessInstance.GatewayCompleteEntry
	nil,                                      // 137: ApiAuthorizationRequest.HeadersEntry
	nil,                                      // 138: ApiAuthenticationRequest.HeadersEntry
	nil,                                      // 139: TelemetryState.LogEntry
	nil,                                      // 140: TelemetryLogEntry.AttributesEntry
	nil,                                      // 141: TaskMetadata.ExtensionDataEntry
	nil,                                      // 142: Parameter.ExtensionDataEntry
	nil,                                      // 143: Exchange.ReceiversEntry
}
var file_shar_workflow_models_proto_depIdxs = []int32{
	23,  // 0: StoreWorkflowRequest.workflow:type_name -> Workflow
	127, // 1: Workflow.process:type_name -> Workflow.ProcessEntry
	...
	128, // 5: Workflow.messageReceivers:type_name -> Workflow.MessageReceiversEntry
	...
	129, // 16: Element.inputTransform:type_name -> Element.InputTransformEntry
	130, // 17: Element.outputTransform:type_name -> Element.OutputTransformEntry
	...
	131, // 26: Timer.outputTransform:type_name -> Timer.OutputTransformEntry
	132, // 27: CatchError.outputTransform:type_name -> CatchError.OutputTransformEntry
	...
	133, // 32: WorkflowState.satisfiesGatewayExpectation:type_name -> WorkflowState.SatisfiesGatewayExpectationEntry
	134, // 33: WorkflowState.gatewayExpectations:type_name -> WorkflowState.GatewayExpectationsEntry
	...
	135, // 42: Gateway.metExpectations:type_name -> Gateway.MetExpectationsEntry
	4,   // 43: WorkflowTimerDefinition.type:type_name -> WorkflowTimerType
	136, // 44: ProcessInstance.gatewayComplete:type_name -> ProcessInstance.GatewayCompleteEntry
	5,   // 45: MessageRecipient.type:type_name -> RecipientType
	137, // 46: ApiAuthorizationRequest.Headers:type_name -> ApiAuthorizationRequest.HeadersEntry
	138, // 47: ApiAuthenticationRequest.headers:type_name -> ApiAuthenticationRequest.HeadersEntry
	...
	139, // 60: TelemetryState.log:type_name -> TelemetryState.LogEntry
	7,   // 61: TelemetryLogEntry.source:type_name -> LogSource
	140, // 62: TelemetryLogEntry.attributes:type_name -> TelemetryLogEntry.AttributesEntry
	...
	141, // 67: TaskMetadata.extensionData:type_name -> TaskMetadata.ExtensionDataEntry
	...
	142, // 77: Parameter.extensionData:type_name -> Parameter.ExtensionDataEntry
	...
	143, // 83: Exchange.receivers:type_name -> Exchange.ReceiversEntry
	30,  // 84: Workflow.ProcessEntry.value:type_name -> Process
	24,  // 85: Workflow.MessageReceiversEntry.value:type_name -> MessageReceivers
	46,  // 86: WorkflowState.SatisfiesGatewayExpectationEntry.value:type_name -> SatisfiesGateway
	47,  // 87: WorkflowState.GatewayExpectationsEntry.value:type_name -> GatewayExpectations
	98,  // 88: TelemetryState.LogEntry.value:type_name -> TelemetryLogEntry
	124, // 89: Exchange.ReceiversEntry.value:type_name -> Receiver
	10,  // 90: Shar.StoreWorkflow:input_type -> StoreWorkflowRequest
	62,  // 91: Shar.CancelProcessInstance:input_type -> CancelProcessInstanceRequest
	60,  // 92: Shar.LaunchProcess:input_type -> LaunchWorkflowRequest
	13,  // 93: Shar.ListWorkflows:input_type -> ListWorkflowsRequest
	63,  // 94: Shar.ListExecutionProcesses:input_type -> ListExecutionProcessesRequest
	67,  // 95: Shar.ListExecution:input_type -> ListExecutionRequest
	74,  // 96: Shar.SendMessage:input_type -> SendMessageRequest
	77,  // 97: Shar.CompleteManualTask:input_type -> CompleteManualTaskRequest
	78,  // 98: Shar.CompleteServiceTask:input_type -> CompleteServiceTaskRequest
	80,  // 99: Shar.CompleteUserTask:input_type -> CompleteUserTaskRequest
	81,  // 100: Shar.ListUserTaskIDs:input_type -> ListUserTasksRequest
	82,  // 101: Shar.GetUserTask:input_type -> GetUserTaskRequest
	84,  // 102: Shar.HandleWorkflowError:input_type -> HandleWorkflowErrorRequest
	79,  // 103: Shar.CompleteSendMessageTask:input_type -> CompleteSendMessageRequest
	86,  // 104: Shar.GetWorkflowVersions:input_type -> GetWorkflowVersionsRequest
	88,  // 105: Shar.GetWorkflow:input_type -> GetWorkflowRequest
	65,  // 106: Shar.GetProcessInstanceStatus:input_type -> GetProcessInstanceStatusRequest
	90,  // 107: Shar.GetProcessHistory:input_type -> GetProcessHistoryRequest
	94,  // 108: Shar.GetVersionInfo:input_type -> GetVersionInfoRequest
	111, // 109: Shar.RegisterTask:input_type -> RegisterTaskRequest
	113, // 110: Shar.GetTaskSpec:input_type -> GetTaskSpecRequest
	115, // 111: Shar.DeprecateServiceTask:input_type -> DeprecateServiceTaskRequest
	117, // 112: Shar.GetTaskSpecVersions:input_type -> GetTaskSpecVersionsRequest
	119, // 113: Shar.GetTaskSpecUsage:input_type -> GetTaskSpecUsageRequest
	121, // 114: Shar.ListTaskSpecUIDs:input_type -> ListTaskSpecUIDsRequest
	21,  // 115: Shar.Heartbeat:input_type -> HeartbeatRequest
	11,  // 116: Shar.StoreWorkflow:output_type -> StoreWorkflowResponse
	12,  // 117: Shar.CancelProcessInstance:output_type -> CancelProcessInstanceResponse
	61,  // 118: Shar.LaunchProcess:output_type -> LaunchWorkflowResponse
	72,  // 119: Shar.ListWorkflows:output_type -> ListWorkflowsResponse
	64,  // 120: Shar.ListExecutionProcesses:output_type -> ListExecutionProcessesResponse
	68,  // 121: Shar.ListExecution:output_type -> ListExecutionResponse
	75,  // 122: Shar.SendMessage:output_type -> SendMessageResponse
	14,  // 123: Shar.CompleteManualTask:output_type -> CompleteManualTaskResponse
	15,  // 124: Shar.CompleteServiceTask:output_type -> CompleteServiceTaskResponse
	16,  // 125: Shar.CompleteUserTask:output_type -> CompleteUserTaskResponse
	17,  // 126: Shar.ListUserTaskIDs:output_type -> ListUserTasksResponse
	83,  // 127: Shar.GetUserTask:output_type -> GetUserTaskResponse
	85,  // 128: Shar.HandleWorkflowError:output_type -> HandleWorkflowErrorResponse
	18,  // 129: Shar.CompleteSendMessageTask:output_type -> CompleteSendMessageResponse
	87,  // 130: Shar.GetWorkflowVersions:output_type -> GetWorkflowVersionsResponse
	89,  // 131: Shar.GetWorkflow:output_type -> GetWorkflowResponse
	19,  // 132: Shar.GetProcessInstanceStatus:output_type -> GetProcessInstanceStatusResponse
	91,  // 133: Shar.GetProcessHistory:output_type -> GetProcessHistoryResponse
	95,  // 134: Shar.GetVersionInfo:output_type -> GetVersionInfoResponse
	112, // 135: Shar.RegisterTask:output_type -> RegisterTaskResponse
	114, // 136: Shar.GetTaskSpec:output_type -> GetTaskSpecResponse
	116, // 137: Shar.DeprecateServiceTask:output_type -> DeprecateServiceTaskResponse
	118, // 138: Shar.GetTaskSpecVersions:output_type -> GetTaskSpecVersionsResponse
	20,  // 139: Shar.GetTaskSpecUsage:output_type -> GetTaskSpecUsageResponse
	122, // 140: Shar.ListTaskSpecUIDs:output_type -> ListTaskSpecUIDsResponse
	22,  // 141: Shar.Heartbeat:output_type -> HeartbeatResponse
