...
type DeprecateServiceTaskRequest struct {
	...
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"` // Spec - the task specification.
}
...
var file_shar_workflow_models_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x59, 0x0a, 0x1c, 0x44, 0x65,
	...
	0x75, 0x73, 0x61, 0x67, 0x65, 0x22, 0xb5, 0x01, 0x0a, 0x13, 0x54, 0x61, 0x73, 0x6b, 0x53, 0x70,
	...
	0x6f, 0x63, 0x65, 0x73, 0x73, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x2a, 0x2d, 0x0a,
...
var file_shar_workflow_models_proto_msgTypes = make([]protoimpl.MessageInfo, 107)
var file_shar_workflow_models_proto_goTypes = []interface{}{
	...
	(*TaskSpecUsageReport)(nil),             // 101: TaskSpecUsageReport
	nil,                                     // 102: Workflow.ProcessEntry
	nil,                                     // 103: Element.InputTransformEntry
	nil,                                     // 104: Element.OutputTransformEntry
	nil,                                     // 105: Timer.OutputTransformEntry
	nil,                                     // 106: CatchError.OutputTransformEntry
	nil,                                     // 107: WorkflowState.SatisfiesGatewayExpectationEntry
	nil,                                     // 108: WorkflowState.GatewayExpectationsEntry
	nil,                                     // 109: Gateway.MetExpectationsEntry
	nil,                                     // 110: ProcessInstance.GatewayCompleteEntry
	nil,                                     // 111: ApiAuthorizationRequest.HeadersEntry
	nil,                                     // 112: ApiAuthenticationRequest.HeadersEntry
	nil,                                     // 113: TelemetryState.LogEntry
	nil,                                     // 114: TelemetryLogEntry.AttributesEntry
	nil,                                     // 115: TaskMetadata.ExtensionDataEntry
	nil,                                     // 116: Parameter.ExtensionDataEntry
}
var file_shar_workflow_models_proto_depIdxs = []int32{
	102, // 0: Workflow.process:type_name -> Workflow.ProcessEntry
	...
	103, // 13: Element.inputTransform:type_name -> Element.InputTransformEntry
	104, // 14: Element.outputTransform:type_name -> Element.OutputTransformEntry
	...
	105, // 23: Timer.outputTransform:type_name -> Timer.OutputTransformEntry
	106, // 24: CatchError.outputTransform:type_name -> CatchError.OutputTransformEntry
	...
	107, // 29: WorkflowState.satisfiesGatewayExpectation:type_name -> WorkflowState.SatisfiesGatewayExpectationEntry
	108, // 30: WorkflowState.gatewayExpectations:type_name -> WorkflowState.GatewayExpectationsEntry
	...
	109, // 39: Gateway.metExpectations:type_name -> Gateway.MetExpectationsEntry
	4,   // 40: WorkflowTimerDefinition.type:type_name -> WorkflowTimerType
	110, // 41: ProcessInstance.gatewayComplete:type_name -> ProcessInstance.GatewayCompleteEntry
	5,   // 42: MessageRecipient.type:type_name -> RecipientType
	111, // 43: ApiAuthorizationRequest.Headers:type_name -> ApiAuthorizationRequest.HeadersEntry
	112, // 44: ApiAuthenticationRequest.headers:type_name -> ApiAuthenticationRequest.HeadersEntry
	...
	113, // 57: TelemetryState.log:type_name -> TelemetryState.LogEntry
	7,   // 58: TelemetryLogEntry.source:type_name -> LogSource
	114, // 59: TelemetryLogEntry.attributes:type_name -> TelemetryLogEntry.AttributesEntry
	...
	115, // 64: TaskMetadata.extensionData:type_name -> TaskMetadata.ExtensionDataEntry
	...
	116, // 74: Parameter.extensionData:type_name -> Parameter.ExtensionDataEntry
	84,  // 75: RegisterTaskRequest.spec:type_name -> TaskSpec
	84,  // 76: GetTaskSpecResponse.spec:type_name -> TaskSpec
	101, // 77: DeprecateServiceTaskResponse.usage:type_name -> TaskSpecUsageReport
	15,  // 78: Workflow.ProcessEntry.value:type_name -> Process
	31,  // 79: WorkflowState.SatisfiesGatewayExpectationEntry.value:type_name -> SatisfiesGateway
	32,  // 80: WorkflowState.GatewayExpectationsEntry.value:type_name -> GatewayExpectations
	82,  // 81: TelemetryState.LogEntry.value:type_name -> TelemetryLogEntry
