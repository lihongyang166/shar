...
var file_shar_workflow_models_proto_rawDesc = []byte{
	...
	,
	...
	0x67, 0x65, 0x22, 0x72, 0x0a, 0x0d, 0x54, 0x61, 0x73, 0x6b, 0x42, 0x65, 0x68, 0x61, 0x76, 0x69,
	...
	0x66, 0x61, 0x75, 0x6c, 0x74, 0x52, 0x65, 0x74, 0x72, 0x79, 0x12, 0x16, 0x0a, 0x06, 0x75, 0x6e,
	...
	0x52, 0x04, 0x6d, 0x6f, 0x63, 0x6b, 0x22, 0x80, 0x02, 0x0a, 0x10, 0x44, 0x65, 0x66, 0x61, 0x75,
	...
	0x63, 0x52, 0x04, 0x73, 0x70, 0x65, 0x63, 0x2a, 0x2d, 0x0a, 0x0d, 0x54, 0x68, 0x72, 0x65, 0x61,
	...
	0x0b, 0x49, 0x6e, 0x63, 0x72, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x61, 0x6c, 0x10, 0x01, 0x2a, 0x65,
	...
	0x6c, 0x6f, 0x77, 0x10, 0x03, 0x42, 0x25, 0x5a, 0x23, 0x67, 0x69, 0x74, 0x6c, 0x61, 0x62, 0x2e,
...
var file_shar_workflow_models_proto_msgTypes = make([]protoimpl.MessageInfo, 103)
var file_shar_workflow_models_proto_goTypes = []interface{}{
	...
	nil,                                     // 106: ProcessInstance.GatewayCompleteEntry
	nil,                                     // 107: ApiAuthorizationRequest.HeadersEntry
	nil,                                     // 108: ApiAuthenticationRequest.HeadersEntry
	nil,                                     // 109: TelemetryState.LogEntry
	nil,                                     // 110: TelemetryLogEntry.AttributesEntry
	nil,                                     // 111: TaskMetadata.ExtensionDataEntry
	nil,                                     // 112: Parameter.ExtensionDataEntry
}
var file_shar_workflow_models_proto_depIdxs = []int32{
	...
	106, // 38: ProcessInstance.gatewayComplete:type_name -> ProcessInstance.GatewayCompleteEntry
	5,   // 39: MessageRecipient.type:type_name -> RecipientType
	107, // 40: ApiAuthorizationRequest.Headers:type_name -> ApiAuthorizationRequest.HeadersEntry
	108, // 41: ApiAuthenticationRequest.headers:type_name -> ApiAuthenticationRequest.HeadersEntry
	...
	109, // 55: TelemetryState.log:type_name -> TelemetryState.LogEntry
	7,   // 56: TelemetryLogEntry.source:type_name -> LogSource
	110, // 57: TelemetryLogEntry.attributes:type_name -> TelemetryLogEntry.AttributesEntry
	84,  // 58: TaskSpec.metadata:type_name -> TaskMetadata
	87,  // 59: TaskSpec.behaviour:type_name -> TaskBehaviour
	85,  // 60: TaskSpec.parameters:type_name -> TaskParameters
	86,  // 61: TaskSpec.events:type_name -> TaskEvents
	111, // 62: TaskMetadata.extensionData:type_name -> TaskMetadata.ExtensionDataEntry
	90,  // 63: TaskParameters.parameterGroup:type_name -> ParameterGroup
	91,  // 64: TaskParameters.input:type_name -> Parameter
	91,  // 65: TaskParameters.output:type_name -> Parameter
	21,  // 66: TaskEvents.error:type_name -> Error
	92,  // 67: TaskEvents.Message:type_name -> Message
	88,  // 68: TaskBehaviour.defaultRetry:type_name -> DefaultTaskRetry
	8,   // 69: DefaultTaskRetry.strategy:type_name -> RetryStrategy
	89,  // 70: DefaultTaskRetry.defaultExceeded:type_name -> DefaultRetryExceededBehaviour
	9,   // 71: DefaultRetryExceededBehaviour.action:type_name -> RetryErrorAction
	112, // 72: Parameter.extensionData:type_name -> Parameter.ExtensionDataEntry
	83,  // 73: RegisterTaskRequest.spec:type_name -> TaskSpec
	83,  // 74: GetTaskSpecResponse.spec:type_name -> TaskSpec
	12,  // 75: Workflow.ProcessEntry.value:type_name -> Process
	28,  // 76: WorkflowState.SatisfiesGatewayExpectationEntry.value:type_name -> SatisfiesGateway
	29,  // 77: WorkflowState.GatewayExpectationsEntry.value:type_name -> GatewayExpectations
	81,  // 78: TelemetryState.LogEntry.value:type_name -> TelemetryLogEntry
