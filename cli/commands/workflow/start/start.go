...
func run(cmd *cobra.Command, args []string) error {
	...
	if flag.Value.DebugTrace {
		...
		err = common.Process(ctx, js, "WORKFLOW-TELEMETRY", "trace", closer, subj.NS(messages.WorkflowStateAll, "*"), "Tracing", 1, func(ctx context.Context, log *slog.Logger, msg *nats.Msg) (bool, error) {
