...
var (
	...
	DefaultTagName = "shar" // struct's field default tag name
)
...
// can be changed in the struct field's tag value. The "shar" key in the
// struct's field tag value is the key name. Example:
//
//	// Field appears in map as key "myName".
//	Name string `shar:"myName"`
//
...
//	Field *Animal `shar:"field,string"`
//
// A tag value with the option of "flatten" used in a struct field is to flatten its fields
// in the output map. Example:
//
//	// The FieldStruct's fields will be flattened into the output map.
//	FieldStruct time.Time `shar:",flatten"`
//
// A tag value with the option of "omitnested" stops iterating further if the type
// is a struct. Example:
//
//	// Field is not processed further by this package.
//	Field time.Time     `shar:"myName,omitnested"`
//	Field *http.Request `shar:",omitnested"`
//
...
//	// skipped if empty.
//	Field string `shar:"myName,omitempty"`
//
//	// Field appears in map as key "Field" (the default), but
//	// the field is skipped if empty.
//	Field string `shar:",omitempty"`
//
...
//	Field time.Time     `shar:",omitnested"`
//	Field *http.Request `shar:",omitnested"`
//
