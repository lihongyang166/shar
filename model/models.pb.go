...
var file_shar_workflow_models_proto_rawDesc = []byte{
	...
	0x6e, 0x74, 0x72, 0x79, 0x52, 0x05, 0x65, 0x6e, 0x74, 0x72, 0x79, 0x22, 0x56, 0x0a, 0x1e, 0x47,
	...
	0x32, 0xd7, 0x10, 0x0a, 0x04, 0x53, 0x68, 0x61, 0x72, 0x12, 0x3e, 0x0a, 0x0d, 0x53, 0x74, 0x6f,
	...
	0x6f, 0x77, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x25, 0x5a, 0x23, 0x67, 0x69,
...
var file_shar_workflow_models_proto_msgTypes = make([]protoimpl.MessageInfo, 158)
var file_shar_workflow_models_proto_goTypes = []interface{}{
	...
	(*GetProcessHeadersRequest)(nil),               // 145: GetProcessHeadersRequest
	(*GetProcessHeadersResponse)(nil),              // 146: GetProcessHeadersResponse
	(*FatalError)(nil),                             // 147: FatalError
	...
	nil,                                            // 156: ProcessHistoryEntry.SatisfiesGatewayExpectationEntry
	nil,                                            // 157: ProcessHistoryEntry.GatewayExpectationsEntry
	nil,                                            // 158: Gateway.MetExpectationsEntry
	nil,                                            // 159: ProcessInstance.GatewayCompleteEntry
	nil,                                            // 160: ApiAuthorizationRequest.HeadersEntry
	nil,                                            // 161: ApiAuthenticationRequest.HeadersEntry
	nil,                                            // 162: TelemetryState.LogEntry
	nil,                                            // 163: TelemetryLogEntry.AttributesEntry
	nil,                                            // 164: TaskMetadata.ExtensionDataEntry
	nil,                                            // 165: Parameter.ExtensionDataEntry
	nil,                                            // 166: Exchange.ReceiversEntry
	nil,                                            // 167: LogRequest.AttributesEntry
	nil,                                            // 168: GetProcessHeadersResponse.HeadersEntry
}
var file_shar_workflow_models_proto_depIdxs = []int32{
	...
	156, // 43: ProcessHistoryEntry.satisfiesGatewayExpectation:type_name -> ProcessHistoryEntry.SatisfiesGatewayExpectationEntry
	157, // 44: ProcessHistoryEntry.gatewayExpectations:type_name -> ProcessHistoryEntry.GatewayExpectationsEntry
	49,  // 45: ProcessHistory.item:type_name -> ProcessHistoryEntry
	158, // 46: Gateway.metExpectations:type_name -> Gateway.MetExpectationsEntry
	4,   // 47: WorkflowTimerDefinition.type:type_name -> WorkflowTimerType
	159, // 48: ProcessInstance.gatewayComplete:type_name -> ProcessInstance.GatewayCompleteEntry
	5,   // 49: MessageRecipient.type:type_name -> RecipientType
	160, // 50: ApiAuthorizationRequest.Headers:type_name -> ApiAuthorizationRequest.HeadersEntry
	161, // 51: ApiAuthenticationRequest.headers:type_name -> ApiAuthenticationRequest.HeadersEntry
