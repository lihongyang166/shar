...
var file_shar_workflow_models_proto_rawDesc = []byte{
	...
	0x22, 0xc6, 0x01, 0x0a, 0x0d, 0x54, 0x61, 0x73, 0x6b, 0x42, 0x65, 0x68, 0x61, 0x76, 0x69, 0x6f,
	...
	0x65, 0x70, 0x72, 0x65, 0x63, 0x61, 0x74, 0x65, 0x64, 0x22, 0x80, 0x02, 0x0a, 0x10, 0x44, 0x65,
	...
	0x6f, 0x77, 0x6e, 0x10, 0x01, 0x32, 0xf6, 0x0f, 0x0a, 0x04, 0x53, 0x68, 0x61, 0x72, 0x12, 0x3e,
	...
	0x72, 0x6b, 0x66, 0x6c, 0x6f, 0x77, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x25,
...
var file_shar_workflow_models_proto_goTypes = []interface{}{
	...
	(*GetWorkflowVersionsRequest)(nil),             // 91: GetWorkflowVersionsRequest
	(*GetWorkflowVersionsResponse)(nil),            // 92: GetWorkflowVersionsResponse
	(*GetWorkflowRequest)(nil),                     // 93: GetWorkflowRequest
	(*GetWorkflowResponse)(nil),                    // 94: GetWorkflowResponse
	(*GetProcessHistoryRequest)(nil),               // 95: GetProcessHistoryRequest
	(*GetProcessHistoryResponse)(nil),              // 96: GetProcessHistoryResponse
	(*GetServiceTaskRoutingIDRequest)(nil),         // 97: GetServiceTaskRoutingIDRequest
	(*GetServiceTaskRoutingIDResponse)(nil),        // 98: GetServiceTaskRoutingIDResponse
	(*GetVersionInfoRequest)(nil),                  // 99: GetVersionInfoRequest
	(*GetVersionInfoResponse)(nil),                 // 100: GetVersionInfoResponse
	(*GetJobRequest)(nil),                          // 101: GetJobRequest
	(*GetJobResponse)(nil),                         // 102: GetJobResponse
	(*ResolveWorkflowRequest)(nil),                 // 103: ResolveWorkflowRequest
	(*ResolveWorkflowResponse)(nil),                // 104: ResolveWorkflowResponse
	(*WorkflowStats)(nil),                          // 105: WorkflowStats
	(*TelemetryState)(nil),                         // 106: TelemetryState
	(*TelemetryLogEntry)(nil),                      // 107: TelemetryLogEntry
	(*TaskSpecVersions)(nil),                       // 108: TaskSpecVersions
	(*TaskSpec)(nil),                               // 109: TaskSpec
	(*TaskMetadata)(nil),                           // 110: TaskMetadata
	(*TaskParameters)(nil),                         // 111: TaskParameters
	(*TaskEvents)(nil),                             // 112: TaskEvents
	(*TaskBehaviour)(nil),                          // 113: TaskBehaviour
	...
	(*FatalError)(nil),                             // 142: FatalError
	nil,                                            // 143: Workflow.ProcessEntry
	nil,                                            // 144: Workflow.MessageReceiversEntry
	nil,                                            // 145: Element.InputTransformEntry
	nil,                                            // 146: Element.OutputTransformEntry
	nil,                                            // 147: Timer.OutputTransformEntry
	nil,                                            // 148: CatchError.OutputTransformEntry
	nil,                                            // 149: WorkflowState.SatisfiesGatewayExpectationEntry
	nil,                                            // 150: WorkflowState.GatewayExpectationsEntry
	nil,                                            // 151: Gateway.MetExpectationsEntry
	nil,                                            // 152: ProcessInstance.GatewayCompleteEntry
	nil,                                            // 153: ApiAuthorizationRequest.HeadersEntry
	nil,                                            // 154: ApiAuthenticationRequest.HeadersEntry
	nil,                                            // 155: TelemetryState.LogEntry
	nil,                                            // 156: TelemetryLogEntry.AttributesEntry
	nil,                                            // 157: TaskMetadata.ExtensionDataEntry
	nil,                                            // 158: Parameter.ExtensionDataEntry
	nil,                                            // 159: Exchange.ReceiversEntry
	nil,                                            // 160: LogRequest.AttributesEntry
}
var file_shar_workflow_models_proto_depIdxs = []int32{
	...
	143, // 2: Workflow.process:type_name -> Workflow.ProcessEntry
	...
	144, // 6: Workflow.messageReceivers:type_name -> Workflow.MessageReceiversEntry
	...
	145, // 17: Element.inputTransform:type_name -> Element.InputTransformEntry
	146, // 18: Element.outputTransform:type_name -> Element.OutputTransformEntry
	...
	147, // 27: Timer.outputTransform:type_name -> Timer.OutputTransformEntry
	148, // 28: CatchError.outputTransform:type_name -> CatchError.OutputTransformEntry
	...
	149, // 33: WorkflowState.satisfiesGatewayExpectation:type_name -> WorkflowState.SatisfiesGatewayExpectationEntry
	150, // 34: WorkflowState.gatewayExpectations:type_name -> WorkflowState.GatewayExpectationsEntry
	...
	151, // 44: Gateway.metExpectations:type_name -> Gateway.MetExpectationsEntry
	4,   // 45: WorkflowTimerDefinition.type:type_name -> WorkflowTimerType
	152, // 46: ProcessInstance.gatewayComplete:type_name -> ProcessInstance.GatewayCompleteEntry
	5,   // 47: MessageRecipient.type:type_name -> RecipientType
	153, // 48: ApiAuthorizationRequest.Headers:type_name -> ApiAuthorizationRequest.HeadersEntry
	154, // 49: ApiAuthenticationRequest.headers:type_name -> ApiAuthenticationRequest.HeadersEntry
	...
	35,  // 58: GetWorkflowVersionsResponse.versions:type_name -> WorkflowVersions
	27,  // 59: GetWorkflowResponse.definition:type_name -> Workflow
	49,  // 60: GetProcessHistoryResponse.entry:type_name -> ProcessHistoryEntry
	46,  // 61: GetJobResponse.job:type_name -> WorkflowState
	27,  // 62: ResolveWorkflowRequest.workflow:type_name -> Workflow
	27,  // 63: ResolveWorkflowResponse.workflow:type_name -> Workflow
	46,  // 64: TelemetryState.state:type_name -> WorkflowState
	155, // 65: TelemetryState.log:type_name -> TelemetryState.LogEntry
	7,   // 66: TelemetryLogEntry.source:type_name -> LogSource
	156, // 67: TelemetryLogEntry.attributes:type_name -> TelemetryLogEntry.AttributesEntry
	110, // 68: TaskSpec.metadata:type_name -> TaskMetadata
	113, // 69: TaskSpec.behaviour:type_name -> TaskBehaviour
	111, // 70: TaskSpec.parameters:type_name -> TaskParameters
	112, // 71: TaskSpec.events:type_name -> TaskEvents
	157, // 72: TaskMetadata.extensionData:type_name -> TaskMetadata.ExtensionDataEntry
	...
	8,   // 79: DefaultTaskRetry.strategy:type_name -> RetryStrategy
	115, // 80: DefaultTaskRetry.defaultExceeded:type_name -> DefaultRetryExceededBehaviour
	9,   // 81: DefaultRetryExceededBehaviour.action:type_name -> RetryErrorAction
	158, // 82: Parameter.extensionData:type_name -> Parameter.ExtensionDataEntry
	109, // 83: RegisterTaskRequest.spec:type_name -> TaskSpec
	109, // 84: GetTaskSpecResponse.spec:type_name -> TaskSpec
	129, // 85: DeprecateServiceTaskResponse.usage:type_name -> TaskSpecUsageReport
	108, // 86: GetTaskSpecVersionsResponse.versions:type_name -> TaskSpecVersions
	132, // 87: Exchange.sender:type_name -> Sender
	159, // 88: Exchange.receivers:type_name -> Exchange.ReceiversEntry
	7,   // 89: LogRequest.source:type_name -> LogSource
	160, // 90: LogRequest.attributes:type_name -> LogRequest.AttributesEntry
	10,  // 91: FatalError.handlingStrategy:type_name -> HandlingStrategy
	46,  // 92: FatalError.workflowState:type_name -> WorkflowState
	34,  // 93: Workflow.ProcessEntry.value:type_name -> Process
	28,  // 94: Workflow.MessageReceiversEntry.value:type_name -> MessageReceivers
	51,  // 95: WorkflowState.SatisfiesGatewayExpectationEntry.value:type_name -> SatisfiesGateway
	52,  // 96: WorkflowState.GatewayExpectationsEntry.value:type_name -> GatewayExpectations
	107, // 97: TelemetryState.LogEntry.value:type_name -> TelemetryLogEntry
	133, // 98: Exchange.ReceiversEntry.value:type_name -> Receiver
	11,  // 99: Shar.StoreWorkflow:input_type -> StoreWorkflowRequest
	67,  // 100: Shar.CancelProcessInstance:input_type -> CancelProcessInstanceRequest
	65,  // 101: Shar.LaunchProcess:input_type -> LaunchWorkflowRequest
	14,  // 102: Shar.ListWorkflows:input_type -> ListWorkflowsRequest
	68,  // 103: Shar.ListExecutionProcesses:input_type -> ListExecutionProcessesRequest
	72,  // 104: Shar.ListExecution:input_type -> ListExecutionRequest
	79,  // 105: Shar.SendMessage:input_type -> SendMessageRequest
	82,  // 106: Shar.CompleteManualTask:input_type -> CompleteManualTaskRequest
	83,  // 107: Shar.CompleteServiceTask:input_type -> CompleteServiceTaskRequest
	85,  // 108: Shar.CompleteUserTask:input_type -> CompleteUserTaskRequest
	86,  // 109: Shar.ListUserTaskIDs:input_type -> ListUserTasksRequest
	87,  // 110: Shar.GetUserTask:input_type -> GetUserTaskRequest
	89,  // 111: Shar.HandleWorkflowError:input_type -> HandleWorkflowErrorRequest
	84,  // 112: Shar.CompleteSendMessageTask:input_type -> CompleteSendMessageRequest
	91,  // 113: Shar.GetWorkflowVersions:input_type -> GetWorkflowVersionsRequest
	93,  // 114: Shar.GetWorkflow:input_type -> GetWorkflowRequest
	70,  // 115: Shar.GetProcessInstanceStatus:input_type -> GetProcessInstanceStatusRequest
	95,  // 116: Shar.GetProcessHistory:input_type -> GetProcessHistoryRequest
	99,  // 117: Shar.GetVersionInfo:input_type -> GetVersionInfoRequest
	120, // 118: Shar.RegisterTask:input_type -> RegisterTaskRequest
	122, // 119: Shar.GetTaskSpec:input_type -> GetTaskSpecRequest
	124, // 120: Shar.DeprecateServiceTask:input_type -> DeprecateServiceTaskRequest
	126, // 121: Shar.GetTaskSpecVersions:input_type -> GetTaskSpecVersionsRequest
	128, // 122: Shar.GetTaskSpecUsage:input_type -> GetTaskSpecUsageRequest
	130, // 123: Shar.ListTaskSpecUIDs:input_type -> ListTaskSpecUIDsRequest
	25,  // 124: Shar.Heartbeat:input_type -> HeartbeatRequest
	136, // 125: Shar.Log:input_type -> LogRequest
	101, // 126: Shar.GetJob:input_type -> GetJobRequest
	103, // 127: Shar.ResolveWorkflow:input_type -> ResolveWorkflowRequest
	12,  // 128: Shar.StoreWorkflow:output_type -> StoreWorkflowResponse
	13,  // 129: Shar.CancelProcessInstance:output_type -> CancelProcessInstanceResponse
	66,  // 130: Shar.LaunchProcess:output_type -> LaunchWorkflowResponse
	77,  // 131: Shar.ListWorkflows:output_type -> ListWorkflowsResponse
	69,  // 132: Shar.ListExecutionProcesses:output_type -> ListExecutionProcessesResponse
	73,  // 133: Shar.ListExecution:output_type -> ListExecutionResponse
	80,  // 134: Shar.SendMessage:output_type -> SendMessageResponse
	15,  // 135: Shar.CompleteManualTask:output_type -> CompleteManualTaskResponse
	16,  // 136: Shar.CompleteServiceTask:output_type -> CompleteServiceTaskResponse
	17,  // 137: Shar.CompleteUserTask:output_type -> CompleteUserTaskResponse
	18,  // 138: Shar.ListUserTaskIDs:output_type -> ListUserTasksResponse
	88,  // 139: Shar.GetUserTask:output_type -> GetUserTaskResponse
	90,  // 140: Shar.HandleWorkflowError:output_type -> HandleWorkflowErrorResponse
	19,  // 141: Shar.CompleteSendMessageTask:output_type -> CompleteSendMessageResponse
	92,  // 142: Shar.GetWorkflowVersions:output_type -> GetWorkflowVersionsResponse
	94,  // 143: Shar.GetWorkflow:output_type -> GetWorkflowResponse
	20,  // 144: Shar.GetProcessInstanceStatus:output_type -> GetProcessInstanceStatusResponse
	96,  // 145: Shar.GetProcessHistory:output_type -> GetProcessHistoryResponse
	100, // 146: Shar.GetVersionInfo:output_type -> GetVersionInfoResponse
	121, // 147: Shar.RegisterTask:output_type -> RegisterTaskResponse
	123, // 148: Shar.GetTaskSpec:output_type -> GetTaskSpecResponse
	125, // 149: Shar.DeprecateServiceTask:output_type -> DeprecateServiceTaskResponse
	127, // 150: Shar.GetTaskSpecVersions:output_type -> GetTaskSpecVersionsResponse
	21,  // 151: Shar.GetTaskSpecUsage:output_type -> GetTaskSpecUsageResponse
	131, // 152: Shar.ListTaskSpecUIDs:output_type -> ListTaskSpecUIDsResponse
	26,  // 153: Shar.Heartbeat:output_type -> HeartbeatResponse
	137, // 154: Shar.Log:output_type -> LogResponse
	102, // 155: Shar.GetJob:output_type -> GetJobResponse
	104, // 156: Shar.ResolveWorkflow:output_type -> ResolveWorkflowResponse
...
func file_shar_workflow_models_proto_init() {
	...
	file_shar_workflow_models_proto_msgTypes[106].OneofWrappers = []interface{}{}
	file_shar_workflow_models_proto_msgTypes[114].OneofWrappers = []interface{}{}
	type x struct{}
