...
var file_shar_workflow_models_proto_rawDesc = []byte{
	...
	0x0c, 0x46, 0x61, 0x69, 0x6c, 0x57, 0x6f, 0x72, 0x6b, 0x66, 0x6c, 0x6f, 0x77, 0x10, 0x03, 0x32,
	0xe3, 0x0e, 0x0a, 0x04, 0x53, 0x68, 0x61, 0x72, 0x12, 0x3e, 0x0a, 0x0d, 0x53, 0x74, 0x6f, 0x72,
...
var file_shar_workflow_models_proto_msgTypes = make([]protoimpl.MessageInfo, 133)
var file_shar_workflow_models_proto_goTypes = []interface{}{
	...
	nil,                                      // 126: Workflow.ProcessEntry
	nil,                                      // 127: Workflow.MessageReceiversEntry
	nil,                                      // 128: Element.InputTransformEntry
	nil,                                      // 129: Element.OutputTransformEntry
	nil,                                      // 130: Timer.OutputTransformEntry
	nil,                                      // 131: CatchError.OutputTransformEntry
	nil,                                      // 132: WorkflowState.SatisfiesGatewayExpectationEntry
	nil,                                      // 133: WorkflowState.GatewayExpectationsEntry
	nil,                                      // 134: Gateway.MetExpectationsEntry
	nil,                                      // 135: ProcessInstance.GatewayCompleteEntry
	nil,                                      // 136: ApiAuthorizationRequest.HeadersEntry
	nil,                                      // 137: ApiAuthenticationRequest.HeadersEntry
	nil,                                      // 138: TelemetryState.LogEntry
	nil,                                      // 139: TelemetryLogEntry.AttributesEntry
	nil,                                      // 140: TaskMetadata.ExtensionDataEntry
	nil,                                      // 141: Parameter.ExtensionDataEntry
	nil,                                      // 142: Exchange.ReceiversEntry
}
var file_shar_workflow_models_proto_depIdxs = []int32{
	23,  // 0: StoreWorkflowRequest.workflow:type_name -> Workflow
	126, // 1: Workflow.process:type_name -> Workflow.ProcessEntry
	...
	127, // 5: Workflow.messageReceivers:type_name -> Workflow.MessageReceiversEntry
	...
	128, // 16: Element.inputTransform:type_name -> Element.InputTransformEntry
	129, // 17: Element.outputTransform:type_name -> Element.OutputTransformEntry
	...
	130, // 26: Timer.outputTransform:type_name -> Timer.OutputTransformEntry
	131, // 27: CatchError.outputTransform:type_name -> CatchError.OutputTransformEntry
	...
	132, // 32: WorkflowState.satisfiesGatewayExpectation:type_name -> WorkflowState.SatisfiesGatewayExpectationEntry
	133, // 33: WorkflowState.gatewayExpectations:type_name -> WorkflowState.GatewayExpectationsEntry
	...
	134, // 42: Gateway.metExpectations:type_name -> Gateway.MetExpectationsEntry
	4,   // 43: WorkflowTimerDefinition.type:type_name -> WorkflowTimerType
	135, // 44: ProcessInstance.gatewayComplete:type_name -> ProcessInstance.GatewayCompleteEntry
	5,   // 45: MessageRecipient.type:type_name -> RecipientType
	136, // 46: ApiAuthorizationRequest.Headers:type_name -> ApiAuthorizationRequest.HeadersEntry
	137, // 47: ApiAuthenticationRequest.headers:type_name -> ApiAuthenticationRequest.HeadersEntry
	...
	138, // 60: TelemetryState.log:type_name -> TelemetryState.LogEntry
	7,   // 61: TelemetryLogEntry.source:type_name -> LogSource
	139, // 62: TelemetryLogEntry.attributes:type_name -> TelemetryLogEntry.AttributesEntry
	...
	140, // 67: TaskMetadata.extensionData:type_name -> TaskMetadata.ExtensionDataEntry
	...
	141, // 77: Parameter.extensionData:type_name -> Parameter.ExtensionDataEntry
	...
	142, // 83: Exchange.receivers:type_name -> Exchange.ReceiversEntry
