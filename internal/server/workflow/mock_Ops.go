...
import (
	...
	usertaskindexer "gitlab.com/shar-workflow/shar/internal/usertaskindexer"
)
...
func (_e *MockOps_Expecter) CompleteUserTask(ctx interface{}, jobId interface{}) *MockOps_CompleteUserTask_Call {
	return &MockOps_CompleteUserTask_Call{Call: _e.mock.On("CompleteUserTask", ctx, jobId)}
}
...
// ListUserTasks provides a mock function with given fields: ctx, ix, owner, group, res, errs
func (_m *MockOps) ListUserTasks(ctx context.Context, ix *usertaskindexer.UserTaskIndexer, owner string, group string, res chan<- *model.ListUserTasksResponse, errs chan<- error) {
	_m.Called(ctx, ix, owner, group, res, errs)
}
...
//   - ctx context.Context
//   - ix *usertaskindexer.UserTaskIndexer
//   - owner string
//   - group string
//   - res chan<- *model.ListUserTasksResponse
//   - errs chan<- error
func (_e *MockOps_Expecter) ListUserTasks(ctx interface{}, ix interface{}, owner interface{}, group interface{}, res interface{}, errs interface{}) *MockOps_ListUserTasks_Call {
	return &MockOps_ListUserTasks_Call{Call: _e.mock.On("ListUserTasks", ctx, ix, owner, group, res, errs)}
}

func (_c *MockOps_ListUserTasks_Call) Run(run func(ctx context.Context, ix *usertaskindexer.UserTaskIndexer, owner string, group string, res chan<- *model.ListUserTasksResponse, errs chan<- error)) *MockOps_ListUserTasks_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*usertaskindexer.UserTaskIndexer), args[2].(string), args[3].(string), args[4].(chan<- *model.ListUserTasksResponse), args[5].(chan<- error))
	})
	return _c
}
...
func (_c *MockOps_ListUserTasks_Call) RunAndReturn(run func(context.Context, *usertaskindexer.UserTaskIndexer, string, string, chan<- *model.ListUserTasksResponse, chan<- error)) *MockOps_ListUserTasks_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockOps) OpenUserTask(ctx context.Context, id string, owner string) ([]byte, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for OpenUserTask")
	}
...
func (_e *MockOps_Expecter) OpenUserTask(ctx interface{}, id interface{}, owner interface{}) *MockOps_OpenUserTask_Call {
	return &MockOps_OpenUserTask_Call{Call: _e.mock.On("OpenUserTask", ctx, id, owner)}
}
...
func (_m *MockOps) ProcessTasks(ctx context.Context, wf *model.Workflow, svcTaskConsFn ServiceTaskConsumerFn, wfProcessMappingFn WorkflowProcessMappingFn) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for ProcessTasks")
	}
...
func (_e *MockOps_Expecter) ProcessTasks(ctx interface{}, wf interface{}, svcTaskConsFn interface{}, wfProcessMappingFn interface{}) *MockOps_ProcessTasks_Call {
	return &MockOps_ProcessTasks_Call{Call: _e.mock.On("ProcessTasks", ctx, wf, svcTaskConsFn, wfProcessMappingFn)}
}
...
func (_m *MockOps) SaveUserTask(ctx context.Context, id string, v []byte, overwrite bool) error {
	ret := _m.Called(ctx, id, v, overwrite)

	if len(ret) == 0 {
		panic("no return value specified for SaveUserTask")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, []byte, bool) error); ok {
		r0 = rf(ctx, id, v, overwrite)
	} else {
		r0 = ret.Error(0)
	}
...
func (_e *MockOps_Expecter) SaveUserTask(ctx interface{}, id interface{}, v interface{}, overwrite interface{}) *MockOps_SaveUserTask_Call {
	return &MockOps_SaveUserTask_Call{Call: _e.mock.On("SaveUserTask", ctx, id, v, overwrite)}
}
