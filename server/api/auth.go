...
func (s *SharServer) authFromInstanceID(ctx context.Context, instanceID string) (context.Context, *model.Execution, error) {
	execution, err := s.ns.GetExecution(ctx, instanceID)
	if err != nil {
