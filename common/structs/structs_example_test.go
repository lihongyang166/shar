...
func ExampleMap_tags() {
	...
	type Server struct {
		Name    string `shar:"server_name"`
		ID      int32  `shar:"server_id"`
		Enabled bool   `shar:"enabled"`
	}
...
func ExampleMap_omitNested() {
	...
	type Server struct {
		Name string    `shar:"server_name"`
		ID   int32     `shar:"server_id"`
		Time time.Time `shar:"time,omitnested"` // do not convert to map[string]interface{}
	}
	//nolint:unused
...
func ExampleMap_omitEmpty() {
	...
	type Server struct {
		Name     string `shar:",omitempty"`
		ID       int32  `shar:"server_id,omitempty"`
		Location string
	}
...
func ExampleValues_tags() {
	...
	type Server struct {
		...
		ID       int32
		Enabled  bool
		Location Location `shar:"-"` // values from location are not included anymore
	}
