...
type ListTaskSpecUIDsResult struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ListTaskSpecUIDsResult) Reset() {
	*x = ListTaskSpecUIDsResult{}
	if protoimpl.UnsafeEnabled {
...
func (x *ListTaskSpecUIDsResult) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListTaskSpecUIDsResult) ProtoMessage() {}

func (x *ListTaskSpecUIDsResult) ProtoReflect() protoreflect.Message {
	mi := &file_shar_workflow_models_proto_msgTypes[96]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListTaskSpecUIDsResult.ProtoReflect.Descriptor instead.
func (*ListTaskSpecUIDsResult) Descriptor() ([]byte, []int) {
	return file_shar_workflow_models_proto_rawDescGZIP(), []int{96}
}

func (x *ListTaskSpecUIDsResult) GetUid() []string {
	if x != nil {
		return x.Uid
	}
	return nil
...
var file_shar_workflow_models_proto_rawDesc = []byte{
	...
	0x75, 0x64, 0x65, 0x44, 0x65, 0x70, 0x72, 0x65, 0x63, 0x61, 0x74, 0x65, 0x64, 0x22, 0x2a, 0x0a,
	0x16, 0x4c, 0x69, 0x73, 0x74, 0x54, 0x61, 0x73, 0x6b, 0x53, 0x70, 0x65, 0x63, 0x55, 0x49, 0x44,
	0x73, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x75, 0x69, 0x64, 0x18, 0x01,
	0x20, 0x03, 0x28, 0x09, 0x52, 0x03, 0x75, 0x69, 0x64, 0x2a, 0x2d, 0x0a, 0x0d, 0x54, 0x68, 0x72,
...
var file_shar_workflow_models_proto_msgTypes = make([]protoimpl.MessageInfo, 112)
var file_shar_workflow_models_proto_goTypes = []interface{}{
	...
	(*ListTaskSpecUIDsRequest)(nil),         // 105: ListTaskSpecUIDsRequest
	(*ListTaskSpecUIDsResult)(nil),          // 106: ListTaskSpecUIDsResult
	nil,                                     // 107: Workflow.ProcessEntry
	nil,                                     // 108: Element.InputTransformEntry
	nil,                                     // 109: Element.OutputTransformEntry
	nil,                                     // 110: Timer.OutputTransformEntry
	nil,                                     // 111: CatchError.OutputTransformEntry
	nil,                                     // 112: WorkflowState.SatisfiesGatewayExpectationEntry
	nil,                                     // 113: WorkflowState.GatewayExpectationsEntry
	nil,                                     // 114: Gateway.MetExpectationsEntry
	nil,                                     // 115: ProcessInstance.GatewayCompleteEntry
	nil,                                     // 116: ApiAuthorizationRequest.HeadersEntry
	nil,                                     // 117: ApiAuthenticationRequest.HeadersEntry
	nil,                                     // 118: TelemetryState.LogEntry
	nil,                                     // 119: TelemetryLogEntry.AttributesEntry
	nil,                                     // 120: TaskMetadata.ExtensionDataEntry
	nil,                                     // 121: Parameter.ExtensionDataEntry
}
var file_shar_workflow_models_proto_depIdxs = []int32{
	107, // 0: Workflow.process:type_name -> Workflow.ProcessEntry
	...
	108, // 13: Element.inputTransform:type_name -> Element.InputTransformEntry
	109, // 14: Element.outputTransform:type_name -> Element.OutputTransformEntry
	...
	110, // 23: Timer.outputTransform:type_name -> Timer.OutputTransformEntry
	111, // 24: CatchError.outputTransform:type_name -> CatchError.OutputTransformEntry
	...
	112, // 29: WorkflowState.satisfiesGatewayExpectation:type_name -> WorkflowState.SatisfiesGatewayExpectationEntry
	113, // 30: WorkflowState.gatewayExpectations:type_name -> WorkflowState.GatewayExpectationsEntry
	...
	114, // 39: Gateway.metExpectations:type_name -> Gateway.MetExpectationsEntry
	4,   // 40: WorkflowTimerDefinition.type:type_name -> WorkflowTimerType
	115, // 41: ProcessInstance.gatewayComplete:type_name -> ProcessInstance.GatewayCompleteEntry
	5,   // 42: MessageRecipient.type:type_name -> RecipientType
	116, // 43: ApiAuthorizationRequest.Headers:type_name -> ApiAuthorizationRequest.HeadersEntry
	117, // 44: ApiAuthenticationRequest.headers:type_name -> ApiAuthenticationRequest.HeadersEntry
	...
	118, // 57: TelemetryState.log:type_name -> TelemetryState.LogEntry
	7,   // 58: TelemetryLogEntry.source:type_name -> LogSource
	119, // 59: TelemetryLogEntry.attributes:type_name -> TelemetryLogEntry.AttributesEntry
	...
	120, // 64: TaskMetadata.extensionData:type_name -> TaskMetadata.ExtensionDataEntry
	...
	121, // 74: Parameter.extensionData:type_name -> Parameter.ExtensionDataEntry
...
func file_shar_workflow_models_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_shar_workflow_models_proto_msgTypes[96].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ListTaskSpecUIDsResult); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
